...
public class PlayerListExpansion extends PlaceholderExpansion {
    ...
    public String onRequest(OfflinePlayer player, String identifier) {
        ...
        } else if (args.size() == 1 || !args.get(1).equals("normal") && !args.get(1).equals("perm") && !args.get(1).equals("world") && !args.get(1).equals("nearby") && !args.get(1).equals("whitelisted") && !args.get(1).equals("banned") && !args.get(1).equals("cansee") && !args.get(1).equals("placeholder") && !args.get(1).equals("version")) {
            return "&3&lValid List SubTypes: &9normal&f, &9perm&f, &9world&f, &9nearby&f &9whitelisted&f, &9banned&f, &9cansee&f, &9placeholder&f, &9version&f.";
        ...
        } else if (args.size() == 4 && (args.get(1).equals("world") || args.get(1).equals("perm") || args.get(1).equals("nearby") || args.get(1).equals("placeholder") && args.get(1).equals("version"))) {
        ...
        switch (args.get(1)) {
            case "normal":
                ...
                if (args.get(3).startsWith("list")) {
                    return players.toString().replace("[", "").replace("]", "").replace(", ", args.get(3).replaceFirst("list-", "")).replace("\\.", ",");
                } else if (args.get(3).equals("amount")) {
                    return players.size() + "";
                } else if (players.size() != 0 && Integer.parseInt(args.get(3)) < players.size()) {
                    return players.get(Integer.parseInt(args.get(3))) + "";
                } else {
                    return "Offline";
                }
            ...
            case "perm":
                ...
                if (args.get(3).startsWith("list")) {
                    return playersPerm.toString().replace("[", "").replace("]", "").replace(", ", args.get(3).replaceFirst("list-", "")).replace("\\.", ",");
                } else if (args.get(3).equals("amount")) {
                    return playersPerm.size() + "";
                } else if (playersPerm.size() != 0 && Integer.parseInt(args.get(3)) < playersPerm.size()) {
                    return playersPerm.get(Integer.parseInt(args.get(3))) + "";
                } else {
                    return "Offline";
                }
            ...
            case "world":
                ...
                for (Player p : listOnline) {
                    if (args.get(2).equals("no") && p.getName().equals(player.getName())) {
                        ...
                        if (("+" + args.get(4) + "+").contains("+" + p.getWorld().getName() + "+")) {
                ...
                if (args.get(3).startsWith("list")) {
                    return playersWorld.toString().replace("[", "").replace("]", "").replace(", ", args.get(3).replaceFirst("list-", "")).replace("\\.", ",");
                } else if (args.get(3).equals("amount")) {
                    return playersWorld.size() + "";
                } else if (playersWorld.size() != 0 && Integer.parseInt(args.get(3)) < playersWorld.size()) {
                    return playersWorld.get(Integer.parseInt(args.get(3))) + "";
                } else {
                    return "Offline";
                }
            ...
            case "nearby":
                ...
                if (args.get(3).startsWith("list")) {
                    return playersNearby.toString().replace("[", "").replace("]", "").replace(", ", args.get(3).replaceFirst("list-", "")).replace("\\.", ",");
                } else if (args.get(3).equals("amount")) {
                    return playersNearby.size() + "";
                } else if (playersNearby.size() != 0 && Integer.parseInt(args.get(3)) < playersNearby.size()) {
                    return playersNearby.get(Integer.parseInt(args.get(3))) + "";
                } else {
                    return "Offline";
                }
            ...
            case "whitelisted":
                ...
                if (args.get(3).startsWith("list")) {
                    return playersWhitelisted.toString().replace("[", "").replace("]", "").replace(", ", args.get(3).replaceFirst("list-", "")).replace("\\.", ",");
                } else if (args.get(3).equals("amount")) {
                    return playersWhitelisted.size() + "";
                } else if (playersWhitelisted.size() != 0 && Integer.parseInt(args.get(3)) < playersWhitelisted.size()) {
                    return playersWhitelisted.get(Integer.parseInt(args.get(3))) + "";
                } else {
                    return "Offline";
                }
            ...
            case "banned":
                ...
                if (args.get(3).startsWith("list")) {
                    return playersBanned.toString().replace("[", "").replace("]", "").replace(", ", args.get(3).replaceFirst("list-", "")).replace("\\.", ",");
                } else if (args.get(3).equals("amount")) {
                    return playersBanned.size() + "";
                } else if (playersBanned.size() != 0 && Integer.parseInt(args.get(3)) < playersBanned.size()) {
                    return playersBanned.get(Integer.parseInt(args.get(3))) + "";
                } else {
                    return "Offline";
                }
            ...
            case "cansee":
                ...
                if (args.get(3).startsWith("list")) {
                    return playersCanSee.toString().replace("[", "").replace("]", "").replace(", ", args.get(3).replaceFirst("list-", "")).replace("\\.", ",");
                } else if (args.get(3).equals("amount")) {
                    return playersCanSee.size() + "";
                } else if (playersCanSee.size() != 0 && Integer.parseInt(args.get(3)) < playersCanSee.size()) {
                    return playersCanSee.get(Integer.parseInt(args.get(3))) + "";
                } else {
                    return "Offline";
                }
            ...
            case "placeholder":
                ...
                Collections.sort(playersPlaceholder);

                if (args.get(3).startsWith("list")) {
                    return playersPlaceholder.toString().replace("[", "").replace("]", "").replace(", ", args.get(3).replaceFirst("list-", "")).replace("\\.", ",");
                } else if (args.get(3).equals("amount")) {
                    return playersPlaceholder.size() + "";
                } else if (playersPlaceholder.size() != 0 && Integer.parseInt(args.get(3)) < playersPlaceholder.size()) {
                    return playersPlaceholder.get(Integer.parseInt(args.get(3))) + "";
                } else {
                    return "Offline";
                }
            ...
            case "version":
                ...
                for (Player p : listOnline) {
                    if (args.get(2).equals("no") && p.getName().equals(player.getName())) {
                        ...
                        for (String version : args.get(4).split("\\+")) {
                            Integer pVer = Via.getAPI().getPlayerVersion(p);
                ...
                Collections.sort(playersVersion);

                if (args.get(3).startsWith("list")) {
                    return playersVersion.toString().replace("[", "").replace("]", "").replace(", ", args.get(3).replaceFirst("list-", "")).replace("\\.", ",");
                } else if (args.get(3).equals("amount")) {
                    return playersVersion.size() + "";
                } else if (playersVersion.size() != 0 && Integer.parseInt(args.get(3)) < playersVersion.size()) {
                    return playersVersion.get(Integer.parseInt(args.get(3))) + "";
                } else {
                    return "Offline";
                }
