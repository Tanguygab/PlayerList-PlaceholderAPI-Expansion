...
public abstract class PlayerList {
	...
	public static PlayerList compile(String text) {
		...
		if (!args.get(0).equals("online") && !args.get(0).equals("offline") && !args.get(0).equals("all")) {
			...
			return new InvalidPlayerList("&3&lValid List SubTypes: &9normal&f, &9perm&f, &9world&f, &9nearby&f &9whitelisted&f, &9banned&f, &9cansee&f, &9placeholder&f, &9version&f.");
			...
			return new InvalidPlayerList("&4&lError&c: &cYou have to specify a &9permission&c/&9world&c/&9radius/placeholder/version&c.");
